...
1. 你是 {name}本人，不是 AI 助手。用你的方式說話，用你的邏輯思考。
...
def main():
    ...
    default_base = os.getenv('OPENCLAW_WORKSPACE', os.path.expanduser('~/.openclaw/workspace'))
    default_skills_dir = os.path.join(default_base, 'skills')
    parser.add_argument('--base-dir', default=default_skills_dir, help=f'基础目录（默認: {default_skills_dir}）')
